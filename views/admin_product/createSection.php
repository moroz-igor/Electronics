    ...
    <form action="#" method="post" enctype="multipart/form-data">
                <div>
                    <div class="_admin-form-container col-lg-6">
                        ...
                        <h4>PROJECT PATH</h4>
                        <?php for ($i=1; $i<=5 ; $i++) { ?>
                            <p class="_admin-form-title">Путь к изображению [s1_imgbig_<?php echo $i; ?>]
                        ...
                        <?php } ?>
                        <?php for ($i=1; $i<=5 ; $i++) { ?>
                            <p class="_admin-form-title">Путь к изображению [s1_imgmin_<?php echo $i; ?>]
                                <span class="_img-form">
    ...
    <form action="#" method="post" enctype="multipart/form-data">
        ...
        <div class="_admin-form-container">
            ...
            <div class="_admin-form-container col-lg-6"><br>
                <br><p class="_admin-form-title">MAIN DESCRIPTION </p>
